           ...
           <div className="flex gap-6 p-10 ">
             <div className=" w-full md:w-1/2 flex flex-col  justify-between space-y-4">
              ...
              <button className="w-full mx-auto flex justify-center items-center gap-2 mb-4 border border-slate-300 py-[5px]">
                    <img className="w-4 h-4" src="/assets/images/facebook.png" alt="" />
                    <span>Sign in with Facebook</span></button>
                <button className="w-full mx-auto border border-slate-300 py-[5px] flex gap-2 items-center  justify-center"><img className="w-4 h-4" src="/assets/images/google.jpg" alt="" /><span>Sign in with Google</span></button>
              </div>
            ...
            <div className="hidden md:block md:w-1/2">
                ...
                <img className="w-full" src="/assets/images/atg_illustration.jpg" alt="illustration" />
            </div>
           </div>
           </div>
        </Modal>
